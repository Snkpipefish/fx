...
export const pct = (v) => (v == null ? "–" : `${v > 0 ? "+" : ""}${nb2.format(v)} %`);
export const pct1 = (v) => (v == null ? "–" : `${v > 0 ? "+" : ""}${nb1.format(v)} %`);
...
// Fast farge per land, så alle grafer og tabeller bruker samme farger. NOK = tekstfargen.
export const COLORS = {
  us: "#2563eb", ea: "#f59e0b", jp: "#10b981", gb: "#ef4444", ch: "#8b5cf6",
  ca: "#06b6d4", au: "#ec4899", nz: "#84cc16", se: "#f97316", no: null,
};
